...
<!-- 11. Using brace expansion (`{...}`), write a one-line command to create 365 empty Markdown files in the format -->
...
<!-- 4. Write the function `usage()` described in the "Workflows" section in the HPC slides from Tuesday. -->
